    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        ...
        <div class="col-xl-5 col-lg-5 pt-3 pt-lg-0 order-1 order-lg-1 d-flex flex-column justify-content-center">
          <h1 class="base_color mb-5">We offer you more value<br> & work for less money</h1>
          <h2 class="mb-0">Check out Plans</h2>
          <p>
            Join our platform of small business owners who trust us with their books
          </p>
        </div>
      </div>
    </div>
        ...
        <div class="row d-flex align-items-center">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="box pricing_box">
                ...
                <div class="contents">
                    <h3>Free</h3>
                    <h4><sup>AED</sup>0<span> / month</span></h4>
                    <div class="mt-3 mb-2 text-muted"><small>Package Features</small></div>
                    <ul>
                      <li>Aida dere</li>
                      <li>Nec feugiat nisl</li>
