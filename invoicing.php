...
<head>
  ...
  <title>McLedger - Invoicing</title>
        ...
        <div class="col-xl-9 d-flex align-items-center">
          ...
          <nav class="nav-menu d-none d-lg-block">
            <ul>
              ...
              <li class="active"><a href="invoicing.php">Invoicing</a></li>
  ...
  <section id="hero" class="d-flex align-items-center invoicing-hero">
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center text-center">
        <div class="col-xl-12 col-lg-12 pt-5 mt-5 pt-lg-0 order-1 order-lg-1 d-flex flex-column justify-content-center">
          <h1 class="mb-1 text-dark">The ultimate invoicing <br>solution for your business</h1>
          <h2 class="mb-5">VAT compliant invoicing to manage payments easily</h2>
...
height: 300px; display: flex; align-content: center; border-radius: 30px;">
    ...
    <section class="invoices_mailing">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-body" style="padding: 60px 40px">
                  <div class="row d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-12 text-center" style="margin-bottom: -30%;">
                      <img src="assets/img/invoicing_mail_screen.png" class="mw-100" alt="">
                    </div>
                  </div>
                </div>
              </div>
