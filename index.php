...
<body>
  ...
  <main id="main">
    ...
    <section id="sub-features" class="sub-features">
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6 col-md-6" data-aos="slide-up" data-aos-delay="100">
            <div class="card-deck p-2">
      ...
      <div class="row">
        <div class="col-md-12 text-center mt-5 mb-5" data-aos="slide-down" data-aos-delay="100">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8" style="background: url(assets/img/flying_envelope.png) center center no-repeat">
            <div class="card" style="width: 470px; background: rgba(239, 242, 243, 0.53); border: none; border-radius: 25px;">
