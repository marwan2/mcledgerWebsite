      ...
      <div class="card mc-card">
         <div class="card-body">
            ...
            <div class="faq-list">
               <ul>
                  <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
                     <a data-toggle="collapse" class="collapse q_content" href="#faq-list-1">Non consectetur a erat nam at lectus urna duis? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                  ...
                  <li data-aos="fade-up" data-aos-delay="200">
                     ...
                     <div id="faq-list-2" class="collapse q_content" data-parent=".faq-list">
                        <p>
                  ...
                  <li data-aos="fade-up" data-aos-delay="300">
                     ...
                     <div id="faq-list-3" class="collapse q_content" data-parent=".faq-list">
                        <p>
                  ...
                  <li data-aos="fade-up" data-aos-delay="400">
                     ...
                     <div id="faq-list-4" class="collapse q_content" data-parent=".faq-list">
                        <p>
                  ...
                  <li data-aos="fade-up" data-aos-delay="500">
                     ...
                     <div id="faq-list-5" class="collapse q_content" data-parent=".faq-list">
                        <p>
            ...
            <div class="pl-4 pr-4 mt-4 mb-4">
               <a href="faq.php" class="btn btn-lg btn_bg btn-primary btn-block mt-3 font-weight-bold">All Questions</a>
            </div>
         </div>
      </div>
   </div>
