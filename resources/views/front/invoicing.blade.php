...
<main id="main">
  <section id="invoicing_desc" class="invoicing_desc">
  ...
  <section id="features" class="features" style="overflow: visible">
    <div class="container" data-aos="fade-up">
      <div class="row whyus_row_op inv_feature1" data-aos="slide-up" data-aos-delay="120">
        <div class="col-md-7">
        ...
        <div class="col-md-5" style="display: flex;align-content: center;align-items: center;">
          <div class="media flex-column">
            <img src="assets/img/point.png" class="mr-2 mb-4">
      ...
      <div class="row whyus_row_op inv_feature1 mb-1" data-aos="slide-up" data-aos-delay="120">
        <div class="col-md-5" style="display: flex;align-content: center;align-items: center;">
          <div class="media flex-column">
            <img src="assets/img/point.png" class="mr-2 mb-4">
            <div class="media-body">
