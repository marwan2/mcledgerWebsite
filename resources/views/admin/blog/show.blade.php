...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <a href="{{ url('admin/blog') }}" class="btn btn-secondary btn-sm">Go Back</a>
        <a href="{{ url('admin/blog/'.$row->id.'/edit') }}" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-pencil"></i> Edit</a>
        ...
        {!! Form::button('<span class="fa fa-trash" />', array(
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
                <tbody>
                    ...
                    <tr><th> Article Title </th><td>{{ $row->title }}</td></tr>
                    <tr><th> Article Body </th><td>{!! $row->details !!}</td></tr>
